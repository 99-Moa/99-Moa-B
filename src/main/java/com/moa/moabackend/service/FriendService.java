...
public class FriendService {
    ...
    // 친구 찾기
    public FriendResDto searchFriend(User user, FriendReqDto friendReqDto){
        // 내 정보
//        User user = userRepository.findByUserName(user.getUserName()).orElseThrow();
        ...
        return new FriendResDto(userFriend);
...
//                            .build()
    ...
    // 친구 삭제
    public String deleteFriend(User user, String userName){
        String userId = user.getUserId();
